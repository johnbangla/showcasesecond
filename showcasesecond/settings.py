"""
Django settings for showcasesecond project.
...
ALLOWED_HOSTS = ['tmth.pythonanywhere.com']
...
ROOT_URLCONF = 'showcasesecond.urls'
...
WSGI_APPLICATION = 'showcasesecond.wsgi.application'
